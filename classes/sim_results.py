...
class SimulationResults:
    ...
    def _calculate_derived_quantities(self):
        ...
        for idx in range(len(self.t)):
            h_dot_i = self.h1[idx]*self.i1[idx] + self.h2[idx] * \
                self.i2[idx] + self.h3[idx]*self.i3[idx]
    ...
    def _setup_3b1b_style(self, ax, title=''):
        ...
        ax.grid(True, alpha=0.4,
                color=self.COLORS['grid'], linestyle='-', linewidth=0.8)
    ...
    def plot_top_view(self, save_path='images/02_top_view_white.png'):
        ...
        _fig, ax = plt.subplots(figsize=(14, 6), facecolor=self.COLORS['bg'])
    ...
    def plot_velocity_vs_time(self, save_path='images/04_velocity_vs_time_white.png'):
        ...
        _fig, ax = plt.subplots(figsize=(14, 8), facecolor=self.COLORS['bg'])
    ...
    def plot_axis_orientation_vs_time(self,
                                      save_path='images/06_axis_orientation_vs_time_white.png'):
    ...
    def plot_axis_orientation_vs_distance(self,
                                          save_path='images/07_axis_orientation_vs_distance_white.png'):
    ...
    def plot_angular_momentum_vs_time(self,
                                      save_path='images/08_angular_momentum_vs_time_white.png'):
        ...
        ax.set_xlabel('Tempo [s]', fontsize=12, fontweight='bold')
        ax.set_ylabel('Momento Angular [rad/s]',
    ...
    def plot_angular_momentum_vs_distance(self,
                                          save_path='images/09_angular_momentum_vs_distance_white.png'):
    ...
    def plot_angle_of_attack_vs_time(self,
                                     save_path='images/10_angle_of_attack_vs_time_white.png'):
    ...
    def plot_angle_of_attack_vs_distance(self,
                                         save_path='images/11_angle_of_attack_vs_distance_white.png'):
